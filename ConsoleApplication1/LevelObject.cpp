...
idSprite idLevelObject::defaultSprite = idSprite();
...
idLevelObject::idLevelObject(int x, int y, idAnimationRegister& animationRegister,
	...
	: position(x,y), spriteRenderer(sprite, position, animationRegister, spriteOffset), collider(*this, position, size, mask, interactionMask)
{
}
